...
System.out.println ("Viewer.setPickingMode " + strMode + " " + pickingMode);
...
if (this.modelkit != null) {
this.modelkit.setProperty ("pickingMode", name);
if (pickingMode != mode && pickingMode == 1) this.setModelKitMode (false);
...
function () {
return (this.g.bondPicking || this.isModelKitOpen () && this.getModelkitProperty ("isMolecular") === Boolean.TRUE || this.isModelkitPickingActive ());
});
...
var f = (false && this.tm.perspectiveDepth ? 1 / this.tm.getPerspectiveFactor ((this.tm.getCameraDepth () - 0.5) * this.getScreenDim ()) : 1) / af;
var m = 0;
var p = 0;
var e = 0;
var mp = 0;
