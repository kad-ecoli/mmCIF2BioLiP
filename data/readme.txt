...
affman        - binding affinity from manual survey of literature
                [1] pdb ID
                [2] chain ID
                [3] binding affinity (pubmed ID)

csa.tsv.gz    - m-csa cataytic site
                [1] pdb ID
                [2] chain ID
                [3] cataytic residue (comma separated list)
