...
"fasta2nr input.fasta output.fasta\n"
"    combine mulitple identical sequences into the same sequence\n"
;
...
size_t fasta2nr(const string &infile, const string &outfile)
{
    stringstream buf;
